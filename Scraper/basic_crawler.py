...
def web_crawler_with_saving_and_urls(id, url):
    ...
    if response.status_code == 200:
        ...
        save_url_to_temp_db(final_url)  # Save the final URL to the temporary database
...
def recursive_crawler(url, depth=1, max_depth=3):
    if depth > max_depth:
        return
...
# Example usage
url_to_crawl = "https://facebook.com"
